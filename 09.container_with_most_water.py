...
# Approach : Fix two pointers for first two line and use two for loops to iterate
#            Store and update maximum value, after the completion of loops return the value

# Solution 2 -- Two Pointers One Pass -- Time complexity : O(n) -- Space complexity : O(1)
class Solution_2:
    def maxArea(height):
        maximum = 0
